<template>
  <main>
    <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px"
      y="0px" width="200px" height="200px" viewBox="100 100 400 400" xml:space="preserve">
    ...
    <div v-if="user" class="user-container">
      <h2 class="welcome-msg">Welcome back, {{ user.name }}!</h2>
      <h3 class="balance">Your balance: {{ getFormattedBalance }}₿</h3>
      <h4 class="rate">Bitcoin/USD Current rate: {{ btcRate }}</h4>
    </div>
